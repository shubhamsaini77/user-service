package org.banking.core.common.dbUtil;

import org.apache.commons.lang3.ArrayUtils;
import org.apache.commons.lang3.StringUtils;
import org.banking.core.common.WhiteRoseUtility;
    ...
    private QueryHolder prepareForInClause(String query, Object[] parameters) {
        ...
        for(int i = 0; i<parameters.length; i++) {
            ...
            if(simpleName.equals("String[]")) {
                String inList = WhiteRoseUtility.toCommaList((String[]) object);
                parameters = buildInQuery(query, parameters, queryHolder, i, inList);
                return queryHolder;
            } else if (simpleName.equals("ArrayList")) {
                String inList = WhiteRoseUtility.toCommaList((ArrayList<String>) object);
                parameters = buildInQuery(query, parameters, queryHolder, i, inList);
                return queryHolder;
            }
        }
